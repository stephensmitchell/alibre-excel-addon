...
Namespace AlibreAddOnAssembly
    ...
    Public Class MenuItem
        ...
        Public Function AboutCmd(ByVal session As IADSession) As IAlibreAddOnCommand
            MessageBox.Show("Steel shapes add-on demo" & vbCrLf & vbCrLf)
            Return Nothing
        End Function
    End Class
    ...
    Public Class MenuManager
        ...
        Public Sub New()
            _rootMenuItem = New MenuItem(401, "alibre-excel-addon", "alibre-excel-addon")
            BuildMenus()
            RegisterMenuItem(_rootMenuItem)
        End Sub

        Private Sub BuildMenus()
            Dim aboutItem = New MenuItem(9090, "About", "https://github.com/stephensmitchell/alibre-excel-addon")
